...
class EmbeddingClient(
    ...
    companion object {
         ...
         * эмпирически, Week 6 День 27: реальный тред из Telegram-экспорта на 5581 символ
         * стабильно падал уже на 2600 символах, при 2500 — проходил). При кириллице
         * токенизация ощутимо менее эффективна, чем при английском тексте (та же природа
         * проблемы, что и с `mxbai-embed-large`, см. README_Week5Day3Rerank.md — там
         * контекст 512 давал практический лимит ~600 символов; пропорция 2048/512 ≈ 4
         * примерно совпадает с 2500/600 ≈ 4 здесь). 2200 — с запасом ниже найденной
